...
<!--Banner pie de pagina-->
	<article class="banner_bottom">
	 ...
	 --><div>
			...
			<a href="<?=$_GET['lang']?>/cinescuela-10190" class="btn_more" onClick="ga('send', 'event', 'Banner home', 'click','Descubre mas - Cinescuela')"><?=$gnrl->textbutton_gnrl?></a>
		</div>
	...
	<nav class="main_menu_footer">
		<ul>
        	<li><a <?php if($_GET['cat']==12){ echo 'class="active"'; } ?> href="<?=$_GET['lang']?>/cinescuela-10190"><span></span>Cinescuela<hr></a></li><!--
